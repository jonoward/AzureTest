...
IF /I "src\AzureTest.sln" NEQ "" (
  call :ExecuteCmd nuget restore "%DEPLOYMENT_SOURCE%\src\AzureTest.sln"
  IF !ERRORLEVEL! NEQ 0 goto error
)
...
IF /I "%IN_PLACE_DEPLOYMENT%" NEQ "1" (
  ...
  call :ExecuteCmd "%MSBUILD_PATH%" "%DEPLOYMENT_SOURCE%\src\AzureTest.Web\AzureTest.Web.csproj" /nologo /verbosity:m /t:Build /p:AutoParameterizationWebConfigConnectionStrings=false;Configuration=Release /p:SolutionDir="%DEPLOYMENT_SOURCE%\src\\" %SCM_BUILD_ARGS%
)
